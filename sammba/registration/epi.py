...
from .base import _reorient, _rigid_body_register_and_reorient, _per_slice_qwarp
    ...
    **environ_kwargs
    ...
    if reorient_only:
        ...
        if epi_brain_file is None:
            raise ValueError(
                "'EPI brain mask file' is needed for " "rigid-body registration"
            )
    ...
    #################################################
    warped_epi_file, warp_files, warped_apply_to_file = _per_slice_qwarp(
        unbiased_epi_file,
